            ...
            <div className="container2">
                <div className="upper2">
                    ...
                    <div className="zoomed-animation2">
                        <span><FontAwesomeIcon icon="fa-solid fa-camera" /></span>
                        <span><FontAwesomeIcon icon="fa-solid fa-play" />3</span>
                        <span id="reaction2"><FontAwesomeIcon icon="fa-solid fa-shuffle" /></span>
                        <span id="reaction2"><FontAwesomeIcon icon="fa-solid fa-heart" /></span>
                    </div>
                    <div className="featured2">Featured</div>

                </div>
                <div className="mid2">
                    <h3 className="price2"><span>$</span>{props.price}</h3>
                    ...
                    <div className="spans2">
                        ...
                        <p id="p-content2">{props.rating} <span>({props.reviews} reviews)</span></p>
                    </div>
                </div>
